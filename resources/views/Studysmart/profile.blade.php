...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>Studysmart</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{ route('contact') }}" class="nav-item nav-link active">Profile</a>
            </div>
            <a href="" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Profile <i class="fa fa-regular fa-user"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
  ...
  <img src="https://t4.ftcdn.net/jpg/05/89/93/27/360_F_589932782_vQAEAZhHnq1QCGu5ikwrYaQD0Mmurm0N.jpg" id="output" width="200" />
  <script>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="name" placeholder="Your Name" style="width: 10%">
                            ...
                            <div class="col-12">
                          <button class="btn btn-primary w-100 py-3" type="submit">Save <i class="fa fa-regular fa-save"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
