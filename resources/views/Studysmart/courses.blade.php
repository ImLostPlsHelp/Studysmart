    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{ route('courses') }}" class="nav-item nav-link active">Kursus</a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Kursus Populer</h1>
            </div>
            <div class="row g-4 justify-content-center">
                @foreach($courses as $course)
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="course-item bg-light" style="border-radius: 15px;">
                            <div class="position-relative overflow-hidden">
                                <img class="img-fluid" style="border-radius: 15px;" src="assets/img/course-1.jpg" alt="">
                                <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="{{ route('courses.view', $course->id) }}"
                                        class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 30px;">Gabung Sekarang</a>
                                </div>
                            </div>
                            <div class="text-center p-4 pb-0">
                                ...
                                <h3 class="mb-4 pb-4 text-uppercase">{{ $course->name }}</h3>
                            </div>
